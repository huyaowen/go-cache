...
func extractFieldList(fieldList *ast.FieldList, imports map[string]string) []Field {
	mFields := make([]Field, 0)
	if fieldList != nil {
...
func extractFields(field *ast.Field, imports map[string]string) []Field {
	mFields := make([]Field, 0)
	if field != nil {
...
func extractField(field *ast.Field, imports map[string]string) *Field {
